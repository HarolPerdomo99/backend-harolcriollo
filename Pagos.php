        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li role="presentation" class="active"><a href="Pagos.php">Finalizar compra</a></li>
                </ul>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="shipAddr">
                    ...
                    <label>
                    <input type="checkbox" name="opcion" value="3"> contraentrega BogotaDC
                    </label>
                    <br>
                    <label>
                    <input type="checkbox" name="opcion" value="3"> Interrapidisimo
                    </label>
                </div>
                <div class="footBtn">
                    <a href="index.php" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i> Volver a la tienda</a>
